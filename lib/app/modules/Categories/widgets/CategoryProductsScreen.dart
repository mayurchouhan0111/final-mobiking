...
class CategoryProductsScreen extends StatelessWidget {
  final String
  categoryName; // To display the parent category name in the AppBar
          ...
          : GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final String imageUrl =
                    (subCategory.photos?.isNotEmpty ?? false)
                  ...
                  onTap: () {
                    ...
                    if (subCategory.products != null &&
                      ...
                      for (var product in subCategory.products!) {
                        print(
                          '- ${product.name}',
                        ); // Assuming your ProductModel has a 'name' field
                      }
                    } else {
                    ...
                    Get.bottomSheet(
                      ...
                      ClipRRect(
                        ...
                        child: Container(
                          color:
                              AppColors.neutralBackground, // Or AppColors.white
                          height:
                              Get.height * 0.85, // Occupy 85% of screen height
                      ...
                      isScrollControlled:
                          true, // Allows the bottom sheet to take more than half screen
                      // Optionally set background color
                      backgroundColor: Colors
                          .transparent, // Let the inner Container define the color
